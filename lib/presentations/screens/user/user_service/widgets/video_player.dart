...
class InfiniteVideoPlayer extends StatefulWidget {
  final String videoPath;
  final bool playFromAsset;

  const InfiniteVideoPlayer({
    super.key,
  ...
  @override
  State<InfiniteVideoPlayer> createState() => _InfiniteVideoPlayerState();
}

class _InfiniteVideoPlayerState extends State<InfiniteVideoPlayer> {
